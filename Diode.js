...
var ASM_CONSTS = {
  466808: function($0, $1) {var rng = window.crypto || window.msCrypto; var entr = Array.from(rng.getRandomValues(new Uint8Array($0))); for (let i = 0; i < $0; i++) { Module.setValue($1 + i, entr[i], "i8"); entr[i] = 0; }},  
 467006: function($0, $1) {var rng = window.crypto || window.msCrypto; var entr = Array.from(rng.getRandomValues(new Uint8Array($0))); for (let i = 0; i < $0; i++) { Module.setValue($1 + i, entr[i], "i8"); entr[i] = 0; }}
};
...
/** @type {function(...*):?} */
var __diode_Init = Module["__diode_Init"] = createExportWrapper("_diode_Init");

/** @type {function(...*):?} */
var __diode_Close = Module["__diode_Close"] = createExportWrapper("_diode_Close");

/** @type {function(...*):?} */
var _main = Module["_main"] = createExportWrapper("main");

/** @type {function(...*):?} */
var __diode_RSA_Keygen = Module["__diode_RSA_Keygen"] = createExportWrapper("_diode_RSA_Keygen");
...
/** @type {function(...*):?} */
var __diode_ED25519_Keygen = Module["__diode_ED25519_Keygen"] = createExportWrapper("_diode_ED25519_Keygen");

/** @type {function(...*):?} */
var __diode_mceliece460896f_Keygen = Module["__diode_mceliece460896f_Keygen"] = createExportWrapper("_diode_mceliece460896f_Keygen");

/** @type {function(...*):?} */
var __diode_SignString_wED25519PrivateBase64Key = Module["__diode_SignString_wED25519PrivateBase64Key"] = createExportWrapper("_diode_SignString_wED25519PrivateBase64Key");

/** @type {function(...*):?} */
var __diode_VerifySig_wED25519PublicBase64Key = Module["__diode_VerifySig_wED25519PublicBase64Key"] = createExportWrapper("_diode_VerifySig_wED25519PublicBase64Key");

/** @type {function(...*):?} */
var __diode_RSA_encapsulate = Module["__diode_RSA_encapsulate"] = createExportWrapper("_diode_RSA_encapsulate");

/** @type {function(...*):?} */
var __diode_RSA_decapsulate = Module["__diode_RSA_decapsulate"] = createExportWrapper("_diode_RSA_decapsulate");

/** @type {function(...*):?} */
var __diode_mceliece460896f_encapsulate = Module["__diode_mceliece460896f_encapsulate"] = createExportWrapper("_diode_mceliece460896f_encapsulate");

/** @type {function(...*):?} */
var __diode_mceliece460896f_decapsulate = Module["__diode_mceliece460896f_decapsulate"] = createExportWrapper("_diode_mceliece460896f_decapsulate");

/** @type {function(...*):?} */
var __diode_RSA_encrypt_wB64 = Module["__diode_RSA_encrypt_wB64"] = createExportWrapper("_diode_RSA_encrypt_wB64");

/** @type {function(...*):?} */
var __diode_RSA_decrypt_wB64 = Module["__diode_RSA_decrypt_wB64"] = createExportWrapper("_diode_RSA_decrypt_wB64");

/** @type {function(...*):?} */
var __diode_mceliece460896f_encrypt_wB64 = Module["__diode_mceliece460896f_encrypt_wB64"] = createExportWrapper("_diode_mceliece460896f_encrypt_wB64");
