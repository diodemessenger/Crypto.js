...
function DiodeCrypto(){
    ...
    crypto.gen_mceliece460896f = () => {
        return new Promise(function (resolve, reject) {
            ...
            /* Free the key strings when done with them */
            ...
            /* Free the pointers objects to string pointers when you don't need to handle strings anymore */
    ...
    crypto.encap_mceliece460896f = (public_key) => {
        return new Promise(function (resolve, reject) {
            ...
            /* Encapsulation, with the public key, to get a secret and out */
            ...
            /* Cleanup of pointer to pointer objects */
